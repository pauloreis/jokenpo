...
<body>
    <div class="mx-auto card" id="box">
        ...
        <form action="jogada" method="post">
            <label for="jogador">Favor informar seu nome:</label>
            <input type="text" name="jogador" id="jogador" class="form-control"/>
            <p><small><form:errors path="jogada.jogador" /></small></p>
            <input type="submit" value="JOGAR" class="btn btn-dark mt-3"/>
        </form>
        </div>
    </div>
